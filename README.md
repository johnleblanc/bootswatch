...
Each raw theme consists of two LESS files. One is `variables.less`, which is included by default in Bootstrap and allows you to customize [these settings](http://twitter.github.com/bootstrap/customize.html#variablesle). The other is called `bootswatch.less` and introduces more extensive structural changes.
